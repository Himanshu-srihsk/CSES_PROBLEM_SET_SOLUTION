...
public class DistanceQueries {
    ...
    public static void main(String[] args) throws IOException {
        ...
        bfs(1); //starting bfs from any random node to calcualte the depth kyuki hmko root yaa pata nai hai
        /*
        ...
        while (q-->0){
            ...
            int b = fs.nextInt();
            int lca = findLca(a,b);
            int distanceBetweenAandB = depth[a]+depth[b]-2*depth[lca];
            ans.append(distanceBetweenAandB).append("\n");
        }
